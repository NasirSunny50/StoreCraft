  ...
  return (
    <div className="mx-auto flex max-w-md flex-col justify-center py-5">
      <div className="overflow-hidden rounded-2xl border border-hairline bg-surface shadow-card-hover">
        {/* Accent header */}
        <div className="relative bg-[linear-gradient(120deg,#e74c3c,#cf3f2f)] px-6 py-4 text-white">
          ...
          <h1 className="mt-2 text-xl font-bold" data-testid="login-heading">Welcome back</h1>
