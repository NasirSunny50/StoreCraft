...
import { SidePromo } from "@/components/storefront/side-promo";
import { FeaturedCategories } from "@/components/storefront/featured-categories";
import { getBannerSet } from "@/lib/banners";

export default async function HomePage() {
  const [categories, banners] = await Promise.all([getCategories(), getBannerSet()]);
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-3 lg:grid-cols-[220px_1fr_220px]">
        ...
        <BannerSlider banners={banners.main} />

        <div className="grid grid-cols-2 gap-3 lg:flex lg:flex-col">
          <SidePromo banner={banners.sideTop}>
            <div className="flex h-full flex-col justify-center bg-[linear-gradient(120deg,#e74c3c,#cf3f2f)] p-4 text-white">
          ...
          <SidePromo banner={banners.sideBottom}>
            <div className="flex h-full flex-col justify-center bg-[linear-gradient(120deg,#1f6fb2,#142033)] p-4 text-white">
