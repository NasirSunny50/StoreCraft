...
export default async function ShopLayout({
  ...
  return (
    ...
    <div className="flex min-h-screen flex-col">
      <SiteHeader />
      <main className="mx-auto w-full max-w-[1440px] flex-1 px-4 py-5 pb-24 lg:px-8 lg:pb-5">
        {children}
      </main>
      ...
      <footer className="mt-10 bg-navbar text-white/70">
        <div className="mx-auto grid max-w-[1440px] grid-cols-2 gap-8 px-4 py-12 lg:px-8 md:grid-cols-4">
          <div>
            <div className="mb-3">
        ...
        <div className="border-t border-white/10">
          <div className="mx-auto max-w-[1440px] px-4 py-4 text-xs text-white/50 lg:px-8">
